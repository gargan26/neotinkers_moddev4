...
public class ModelLayers {
   ...
   public static ModelLayerLocation createRaftModelName(Boat.Type pType) {
      return createLocation("raft/" + pType.getName(), "main");
   }

   public static ModelLayerLocation createChestRaftModelName(Boat.Type pType) {
      return createLocation("chest_raft/" + pType.getName(), "main");
   }

   public static ModelLayerLocation createBoatModelName(Boat.Type pType) {
      return createLocation("boat/" + pType.getName(), "main");
   }

   public static ModelLayerLocation createChestBoatModelName(Boat.Type pType) {
      return createLocation("chest_boat/" + pType.getName(), "main");
   }

   public static ModelLayerLocation createSignModelName(WoodType pWoodType) {
      ResourceLocation location = new ResourceLocation(pWoodType.name());
      return new ModelLayerLocation(new ResourceLocation(location.getNamespace(), "sign/" + location.getPath()), "main");
   }

   public static ModelLayerLocation createHangingSignModelName(WoodType pWoodType) {
      ResourceLocation location = new ResourceLocation(pWoodType.name());
