...
public class ItemFrame extends HangingEntity {
   ...
   protected static final EntityDataAccessor<Integer> DATA_ROTATION = SynchedEntityData.defineId(ItemFrame.class, EntityDataSerializers.INT);
   ...
   protected void setRotation(int pRotation, boolean pUpdateNeighbours) {
