...
public class ApplyBonusCount extends LootItemConditionalFunction {
   public static final Map<ResourceLocation, ApplyBonusCount.FormulaDeserializer> FORMULAS = Maps.newHashMap();
    ...
    * probability}.
    */
   public static final class BinomialWithBonusCount implements ApplyBonusCount.Formula {
    ...
    */
   public static final class OreDrops implements ApplyBonusCount.Formula {
    ...
    */
   public static final class UniformBonusCount implements ApplyBonusCount.Formula {
